 ...
 * @author fahmi
 */
public class Masyarakat extends javax.swing.JInternalFrame {
Connection connection =  new DBHelper().init();
CardLayout cardLayout;
String id,nama,username,password,telp,mstatus;
    /**
    ...
    private void initComponents() {
        ...
        jLabel9.setText("FORM MASYARAKAT");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(eusername, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(epassword, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(etelp, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusActionPerformed
        ...
        if(konfirmasi==JOptionPane.YES_OPTION){        
            try {
                ...
                String sql = "delete from masyarakat where id_user='"+this.id+"'";
                s.executeUpdate(sql);
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        ...
        if (mstatus=="tambah"){
            ...
            if(konfirmasi==JOptionPane.YES_OPTION){
                try {
                    String sql="insert into masyarakat values('"
                    + eid.getText()+"','"
                    + enama.getText()+"','"
                    + eusername.getText()+"','"
                    + epassword.getText()+"','"
            ...
            if(konfirmasi==JOptionPane.YES_OPTION){
                try{
                    Statement s = connection.createStatement();
                    String sql = "update masyarakat set nama_lengkap='"+enama.getText()+"',"+"username='"+eusername.getText()+"',"+"password='"+epassword.getText()+"',"+"telp='"+etelp.getText()+"' where id_user='"+eid.getText()+"'";
                    s.executeUpdate(sql);
                    s.close();
