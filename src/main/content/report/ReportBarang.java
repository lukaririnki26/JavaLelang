 ...
 * @author fahmi
 */
public class ReportBarang extends javax.swing.JInternalFrame {
Connection connection =  new DBHelper().init();
String id,nama,tgl,harga,desk;
    /**
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(887, 511));
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        this.desk = defaultmodel.getValueAt(row, 4).toString();
    }//GEN-LAST:event_tabelMouseClicked

    private void refreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshActionPerformed
        // TODO add your handling code here:
//        if (defaultmodel.getRowCount() >0) {
//            for (int i = defaultmodel.getRowCount()-1; i > -1; i--) {
...
//        }
    ...
    private void cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cetakActionPerformed
        // TODO add your handling code here:
        new Laporan("reportBarang.jasper");
